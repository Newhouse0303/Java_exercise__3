...
3) ShapeManager and 4) abstract class Shape and its subclasses. The first one could be a cleaner, 
but it is basically responsible for passing the user input (type of shape) to the ShapeManager which 
...
The class Shape offers the basic attribytes shared by all "subshapes" ( number of coordinate Points, list of the Points )
...
call the methods in the Triangle class thus using the correct method (see line 88).
